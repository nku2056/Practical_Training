...
public class YqDataMonthAll implements Serializable {
    private String date;
    ...
    public YqDataMonthAll() {
    }

    public YqDataMonthAll(String date, Integer sumConfirmed, Integer sumSuspected, Integer sumCured, Integer sumDead, Integer tdConfirmed, Integer incConfirmed, Integer incDead, Integer incCured) {
        this.date = date;
