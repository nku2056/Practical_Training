...
public class YqDataMonth implements Serializable {
    ...
    public YqDataMonth(String province, String date, Integer sumConfirmed, Integer sumSuspected, Integer sumCured, Integer sumDead, Integer tdConfirmed, Integer incConfirmed, Integer incDead, Integer incCured) {
